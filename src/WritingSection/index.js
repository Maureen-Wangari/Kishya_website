...
return(
   <div className="body">
     ...
     <div className="cardOne">
      <h2 id="cardHeading"> <a href="#firstCard" >Exploring Identity Amidst Adversity</a></h2>
     ...
     <h2 id="cardHeading"> <a href="#firstCard" >Relevance in Today's Sociopolitical Context</a></h2>
     ...
     <div className="cardOne">
     <h2 id="cardHeading"> <a href="#firstCard">The Power of Humor and Hope</a></h2>
     ...
     <div className="cardTwo">
     <h2 id="cardHeading"> <a href="#firstCard">Embracing Diversity and Inclusion</a></h2>
     <p className="cardContent">In today's diverse and interconnected world, Noah's memoir advocates for embracing diversity and fostering inclusion across cultural and racial boundaries.
     <a href="#fourthCard">Read more..</a>
     </p>
     </div>
     </div>
        <h2 className="cardtitles">Exploring Identity Amidst Adversity</h2>
        ...
        <h2 className="cardtitles">Relevance in Today's Sociopolitical Context</h2>
        ...
        <h2 className="cardtitles">The Power of Humor and Hope</h2>
        ...
        <h2 className="cardtitles">Embracing Diversity and Inclusion</h2>
        ...
        <h2 >References</h2>
        <p>
        <a href="https://pursuitofdiversity.files.wordpress.com/2018/06/born-a-crime-trevor-noah.pdf"  id="ref">Noah, Trevor. Born a Crime: Stories from a South African Childhood. Spiegel & Grau, 2016.</a>
        </p>
     </div>
   </div>
)
